...
public class ZombieTechGameCommandApiWalkthroughTest {
    ...
    public static void createAUser(){
        ...
        RestMudInMemoryConfig config = new RestMudInMemoryConfig()
                ...
                .gameNamed("techWebTest101Game.json");
    ...
    public void canPlayGameUsingTheAPIAsSingleUserFromCommandFile(){
        ...
        List<Command> commands = CommandListFile.read(Paths.get(System.getProperty("user.dir"), "..", "tech-web-test-restmud-game", "docs", "zombie_zork_walkthrough_commands.txt").toString());
