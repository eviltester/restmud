...
public class TreasureHuntGameCommandApiWalkthroughTest {
    ...
    public void canPlayGameUsingTheAPIAsSingleUserFromCommandFile(){
        ...
        List<Command> commands = CommandListFile.read(Paths.get(System.getProperty("user.dir"), "..", "treasurehuntgame", "docs", "treasure_hunt_basic_walkthrough_commands.txt").toString());
