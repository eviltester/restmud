...
public class BasicGameCommandApiWalkthroughTest {
    ...
    public void canPlayGameUsingTheAPIAsSingleUserFromCommandFile(){
        ...
        List<Command> commands = CommandListFile.read(Paths.get(System.getProperty("user.dir"), "..", "basictestgame", "docs", "test_game_basic_walkthrough_commands.txt").toString());
