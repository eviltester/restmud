...
public class RandomlyGenerateHoardableJunk implements ScriptThenCommand {
    private final MudGame game;

    public RandomlyGenerateHoardableJunk(MudGame game) {
        this.game = game;
    }

    @Override
    public String getCommandName() {
        return Then.RANDOMLY_GENERATE_HOARDABLE_JUNK;
    }
    ...
    public ProcessConditionReturn execute(ScriptClause scriptClause, MudUser player) {
        ...
        moneygod.createHoardableJunk(numberOfTreasures);
